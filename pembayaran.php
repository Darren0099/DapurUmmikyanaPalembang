...
foreach ($_SESSION['cart'] as $item) {
    ...
    $produk_id_str = implode(', ', $produk_id); // Gabungkan menu_id sebagai string
    ...
    if ($query_pemesanan->execute()) {
        ...
        if ($query_pembayaran->execute()) {
            ...
            unset($_SESSION['cart']);
            echo "<script>alert('Pemesanan Berhasil!'); window.location='status.php';</script>";
            exit;
        } else {
        ...
        <div class="payment-section">
            ...
            <div class="tab-content" id="metode_pembayaran">
                ...
                <div id="dana">
                    <h3>DANA</h3>
                    <p>081234567891</p>
                    <img src="asset/dana.jpg" alt="QR Code DANA" style="max-width: 200px; margin-top: 10px;">
                </div>
            </div>
            ...
            <form action="pembayaran.php" method="post">
                ...
                <button class="pay-button"><p><strong>Pesan dan Bayar Rp. <?= number_format($total_pembayaran, 0, ',', '.') ?></strong></p></button>
            </form>
        </div>
    </div>
